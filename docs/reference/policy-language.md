...
Neksur Access policies are written in **CEL** (Common Expression Language, `cel-go`). This page is the complete reference for the evaluation environment, helper functions, and policy kinds. For a task-oriented walkthrough with examples, see the guide [Author Access policies](../guides/author-access-policies.md).
...
- [Author Access policies](../guides/author-access-policies.md) — the guide.
- [Meaning, Access, State](../concepts/dimensions.md)
- [Architecture → policy engine](../architecture/overview.md)
