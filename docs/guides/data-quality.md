...
A breach produces a record in the metadata graph linked to the dataset and the governing Contract, so it shows up in the Contract's Quality view and in the **Activity** feed. Combined with the [audit chain](./compliance-and-audit.md), this is the *Prove* job: defensible evidence of whether quality guarantees held over time.
