...
- [The Data Contract → AI agents as Contract consumers](../concepts/data-contract.md#ai-agents-as-contract-consumers)
- [Author Access policies](./author-access-policies.md) — what the agent's results are filtered by.
- [Architecture → API surface](../architecture/overview.md#api-surface)
