...
For the product-side view of editions (what each tier *does*), see [Concepts: Editions and tiers](../concepts/editions.md). This page covers the legal/licensing facts.
...
See [Editions and tiers](../concepts/editions.md) for what each tier contains in detail.
...
- **Change date: 2030-05-10.** On that date, the then-current Core converts to Apache 2.0. Because of the [one-way ratchet](../concepts/editions.md#the-one-way-ratchet), the Core that converts is a strictly *growing* surface — components only ever move from Commercial into Core, never out.
