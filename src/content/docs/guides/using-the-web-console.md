...
description: "The Neksur web console is organized around the Data Contract. This is a tour of its screens and the main workflows."
---

**Edition:** Core. Some surfaces are role-gated (admin / DPO) or edition-gated, as noted.

The Neksur web console is organized around the [Data Contract](/concepts/data-contract/). This is a tour of its screens and the main workflows.
...
- **Dimension tabs** (fixed order):
  - **Meaning** — author metrics/dimensions (YAML + form, compile-on-save). See [Author semantic metrics](/guides/author-semantic-metrics/).
  - **Access** — author row filters, column masks, and retention rules, with a live compiled-policy preview. See [Author Access policies](/guides/author-access-policies/).
...
The full walkthrough is in [Author and ship a Data Contract](/guides/author-and-ship-a-contract/).
