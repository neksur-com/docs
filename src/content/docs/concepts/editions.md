---
title: "Editions and tiers"
description: "Neksur ships as a single binary. What it can do is determined by a signed license file that gates feature flags at startup. There is no separate…"
---
...
- [Licensing](/licensing/) — the BSL, what "non-competing use" means, and commercial inquiries.
- [Enforcement model](/concepts/enforcement/) — where each tier's capabilities act in the data path.
- [What is Neksur?](/intro/what-is-neksur/)
